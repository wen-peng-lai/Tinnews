...
import com.wen.tinnews.databinding.SavedNewsItemBinding;
...
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder> {
    ...
    public static class SavedNewsViewHolder extends RecyclerView.ViewHolder {
        ...
        public SavedNewsViewHolder(@NonNull View itemView) {
            super(itemView);
            SavedNewsItemBinding uniBinding = SavedNewsItemBinding.bind(itemView);
            authorTextView = uniBinding.savedItemAuthorContent;
            descriptionTextView = uniBinding.savedItemDescriptionContent;
            favoriteIcon = uniBinding.savedItemFavoriteImageView;
        }
    }
}
